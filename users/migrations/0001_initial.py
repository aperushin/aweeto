    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(max_length=254, unique=True, validators=[users.validators.NotOnDomainValidator('rambler.ru')])),
                ('birth_date', models.DateField(null=True, validators=[users.validators.IsOlderThanValidator(9)])),
